...
public class DefaultMQPushConsumerImpl implements MQConsumerInner {
    ...
    /**
     * 从pullRequestQueue中拿到pullRequest然后去拉取
     *
     * @param pullRequest
     */
                    ...
                    switch (pullResult.getPullStatus()) {
                        case FOUND:
                            ...
                            if (pullResult.getMsgFoundList() == null || pullResult.getMsgFoundList().isEmpty()) {
                                ...
                                // 将拉取到的消息放入到PullRequest的processQueue中
                                ...
                                // 将PullRequest放回到PullMessageService的pullRequestQueue中
                        ...
                        case OFFSET_ILLEGAL:
                            ...
                            // 重置pullRequest的nextOffset(下一个要读取的消息的offset)
                            pullRequest.setNextOffset(pullResult.getNextBeginOffset());
    ...
    public synchronized void start() throws MQClientException {
        switch (this.serviceState) {
            case CREATE_JUST:
                ...
                // 根据Listener的不同选择不同的ConsumeMessageService
                ...
                if (!registerOK) {
                    ...
                    throw new MQClientException("The consumer group[" + this.defaultMQPushConsumer.getConsumerGroup()
                            ...
                            FAQUrl.GROUP_NAME_DUPLICATE_URL),
                            null);
                }
        ...
        try {
            ...
            switch (this.defaultMQPushConsumer.getMessageModel()) {
                ...
                case CLUSTERING:
                    ...
                    SubscriptionData subscriptionData = FilterAPI.buildSubscriptionData(retryTopic,
    ...
    public void persistConsumerOffset() {
        try {
            ...
            log.error("group: " + this.defaultMQPushConsumer.getConsumerGroup() + " persistConsumerOffset exception",
                    e);
        }
    }
    ...
    public ConsumerRunningInfo consumerRunningInfo() {
        ...
        Iterator<Entry<MessageQueue, ProcessQueue>> it = this.rebalanceImpl.getProcessQueueTable().entrySet()
                .iterator();
        while (it.hasNext()) {
    ...
    public List<QueueTimeSpan> queryConsumeTimeSpan(final String topic)
        ...
        TopicRouteData routeData = this.mQClientFactory.getMQClientAPIImpl()
                .getTopicRouteInfoFromNameServer(topic, 3000);
        for (BrokerData brokerData : routeData.getBrokerDatas()) {
            String addr = brokerData.selectBrokerAddr();
            queueTimeSpan.addAll(
                    this.mQClientFactory.getMQClientAPIImpl().queryConsumeTimeSpan(addr, topic, groupName(), 3000));
        }
